					...
					<div class="invoice">
						<header class="clearfix">
							<div class="row">
								<div class="col-xs-6">
									<div class="ib">
										<img src="<?=base_url('uploads/app_image/printing-logo.png')?>" height="50px" width="50px" alt="RamomCoder Img" />
									</div>
								</div>
									...
									<ul class="amounts">
										...
										<li>
											...
											<?php
													if (class_exists('NumberFormatter')) {
														...
														echo $currency_symbol . number_format($total_balance, 2, '.', '') . ' <br>( ' . ucwords($total_balance) . ' )';
													}
													?>
										</li>
										<?php else: ?>
										<li>
											...
											<?php
												if (class_exists('NumberFormatter')) {
													$f = new NumberFormatter("en", NumberFormatter::SPELLOUT);
													$amount = $total_paid + $total_fine;
													echo $currency_symbol . number_format($amount, 2, '.', '') . ' <br>( ' . ucwords($f->format($amount)) . ' )';
												} else {
													$amount = $total_paid + $total_fine;
													echo $currency_symbol . number_format($amount, 2, '.', '') . ' <br>( ' . ucwords($amount) . ' )';
												}
												?>
										</li>
										<?php endif; ?>
