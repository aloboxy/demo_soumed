				...
				<div class="row">
					...
					<div class="col-md-4 mb-sm">
						<div class="form-group">
							...
							<input type="text" class="form-control" name="state" value="<?=set_value('county')?>" />
						</div>
					</div>
				</div>
				...
				<div class="row mb-md">
					<div class="col-md-6 mb-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="text" class="form-control" name="email" id="email" value="<?=set_value('email', $register_id)?>" />
							</div>
					...
					<div class="col-md-3 mb-sm">
						<div class="form-group">
							...
							<div class="input-group">
								...
								<input type="password" class="form-control" name="password" value="<?=set_value('password',$register_id)?>" />
							</div>
					...
					<div class="col-md-3 mb-sm">
						<div class="form-group">
							...
							<div class="input-group">
								<span class="input-group-addon"><i class="fas fa-unlock-alt"></i></span>
								<input type="password" class="form-control" name="retype_password" value="<?=set_value('retype_password',$register_id)?>" />
							</div>
