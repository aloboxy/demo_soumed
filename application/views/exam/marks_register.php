				...
				<div class="row mb-sm">
					...
					<!--<div class="col-md-3 mb-sm">
						<div class="form-group">
							...
							<?php
								$AcademicYear = $this->application_model->exam_years();
								$arrayAcademicYear = array('' => 'Select'); // Default option

								foreach ($AcademicYear as $row) {
									$arrayAcademicYear[$row->id] = $row->school_year; 
								...
								echo form_dropdown(
									"academic_year_id",
									$arrayAcademicYear,
									set_value('academic_year_id'),
									"class='form-control' id='schoolyear' required data-plugin-selectTwo data-width='100%' data-minimum-results-for-search='Infinity'"
								);
							?>
						</div>
					</div>-->
