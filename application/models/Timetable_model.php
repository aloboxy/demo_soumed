...
class Timetable_model extends CI_Model
{
    ...
    public function getExamTimetableList($classID, $sectionID, $branchID)
    {
        ...
        // Group by all columns from the main table to avoid ONLY_FULL_GROUP_BY error
        $this->db->group_by(array('t.id', 't.exam_id', 't.branch_id', 't.class_id', 't.section_id', 't.subject_id', 
                                 't.hall_id', 't.exam_date', 't.time_start', 't.time_end', 't.session_id', 
                                 't.created_at', 't.updated_at', 'b.name'));
